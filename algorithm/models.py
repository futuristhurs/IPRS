...
class PropertyExtraInfo(models.Model):
    ...
    bedroom = models.PositiveIntegerField()  # Enforce positive number of bedrooms
    bathroom = models.PositiveIntegerField()  # Enforce positive number of bathrooms
    ...
    area = models.PositiveIntegerField()  # Ensure positive area
